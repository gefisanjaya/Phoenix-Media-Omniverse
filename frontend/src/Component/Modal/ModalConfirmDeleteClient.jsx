...
const ModalConfirmDeleteClient = ({ show, onClose, onConfirm, client }) => {
  if (!show) {
    return null;
  }
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-75">
      <div className="bg-white p-6 rounded shadow-lg w-[28rem]">
        ...
        <p>Are you sure you want to delete client <strong>{client?.nama}</strong>?</p>
...
export default ModalConfirmDeleteClient;
