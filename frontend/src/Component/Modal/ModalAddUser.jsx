      ...
      <div className="bg-white p-6 rounded shadow-lg w-[28rem]">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input type="text" value={username} onChange={(e) => setUsername(e.target.value)} className="w-full border border-gray-300 p-2 rounded" required />
          </div>
          {!initialData && (
            <div className="mb-4">
          ...
          <div className="mb-4">
            ...
            <select value={role} onChange={(e) => setRole(e.target.value)} className="w-full border border-gray-300 p-2 rounded" required>
